...
const FeatureList = [
  {
    ...
    description: (
      <>
        The Harness CD Community Edition is provided under a source-available license called the 
        <a href="https://polyformproject.org/licenses/shield/1.0.0/">Polyform Shield License</a>
  ...
  },
  {
    ...
    description: (
      <>
        The Harness CI Team Edition (powered by Drone) is made available under a source-available license called the&nbsp;
        <a href="https://polyformproject.org/licenses/noncommercial/1.0.0/" target="_blank">Polyform Small Business License</a>
